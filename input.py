...
names = input("Type your names separated by commas: ").title().split(",") # get and process input for a list of names
assignments = input("Type your assignment counts separated by commas: ").split(",") # get and process input for a list of the number of assignments
grades = input("Type your grades separated by commas: ").split(",") # get and process input for a list of grades
